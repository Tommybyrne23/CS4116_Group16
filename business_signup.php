...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password) || empty($name) || empty($description) || empty($contactInfo) || empty($logoURL)) {
        ...
        if (usernameExists($conn, $username)) {
            ...
            if(registerBusiness($conn, $username, $password, $name, $description, $contactInfo, $logoURL)){
